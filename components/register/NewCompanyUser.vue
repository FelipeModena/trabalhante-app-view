  ...
  <div>
    <b-form>
      ...
      <b-form-group
        ...
        label-for="register-uf"
        description="Ela poderá ser editada futuramente, não se preocupe"
      >
        <b-form-textarea
          id="textarea"
          v-model="companyDescription"
          placeholder="Descrição da empresa, o que ela faz, serviços prestados, modelo de trabalho, etc"
          rows="6"
        ></b-form-textarea>
      </b-form-group>
